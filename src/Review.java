...
public class Review {
    ...
    /**
     * @param word - the word to calculate the sentiment value of.
    ...
    /**
     * @param word - the word to examine for punctuation.
     * @return the ending punctuation of a string, or the empty string if there is none
     */
